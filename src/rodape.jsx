    ...
    <footer className="rodape">
      <div className="redes-sociais">
        <ul>
          ...
          <li><a href="https://api.whatsapp.com/send?phone=SEUNUMERO">WhatsApp</a><img src="./public/whatsapp.png" alt="" className="icone"/></li>
          <li><a href="https://www.linkedin.com">LinkedIn</a> <img src="./public/linkedin.png" alt="" className="icone" /></li>
